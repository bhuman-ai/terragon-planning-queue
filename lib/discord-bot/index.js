...
class MetaAgentDiscordBot {
  ...
  async handleQuestionResponse(pendingQuestion, message) {
    ...
    try {
      ...
      const response = await axios.post(`${this.baseUrl}/api/task/active/response`, {
        taskId,
        response: message.content,
        respondedBy: message.author.username,
  ...
  async handleDontKnow(interaction, taskId) {
    ...
    try {
      ...
      await axios.post(`${this.baseUrl}/api/task/active/response`, {
        taskId,
        response: "I don't know",
        respondedBy: interaction.user.username,
        timestamp: new Date().toISOString()
      });
