...
class TaskDecomposer {
  ...
  async decompose(taskSpec, requirements = {}, codebaseContext = {}) {
    ...
    try {
      let prompt = this.buildIntelligentDecompositionPrompt(taskSpec, requirements, codebaseContext);
  ...
  buildIntelligentDecompositionPrompt(taskSpec, requirements, codebaseContext) {
    ...
    let prompt = `You are an expert software architect tasked with intelligently decomposing a complex development task into precise, implementable micro-tasks.
