  ...
  async generatePreResearchQuestions(message, context = {}) {
    ...
    try {
      const response = await this.claude.messages.create({
        ...
        messages: [{
          role: 'user',
          content: `You are an intelligent requirements analyst. The user has made this specific request:
...
1. Read the project context above FIRST - if available, it contains the project's sacred requirements
2. Generate ONLY questions that are directly related to the user's specific request: "${message}"
3. DO NOT ask generic project setup questions - focus on clarifying THIS specific task
4. If the project context answers a potential question, DON'T ASK IT
5. Generate 3-5 questions that will help you understand exactly what the user wants for THIS task

Examples of GOOD questions for "update calibration for CLAUDE.md":
- What specific changes do you want to make to the calibration process?
- Are there particular fields or sections in CLAUDE.md that need updating?
- Do you want to modify the questions asked during calibration?
